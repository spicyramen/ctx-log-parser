...
import javax.sip.viewer.SipTextFormatter;
...
public class SipTextViewer {
  ...
  protected ArrayList<String> diagramMessages = new ArrayList<String>();

  public ArrayList<String> display(OutputStream pOut) throws Exception {
    ...
    diagramMessages.add("\n");
    diagramMessages.add(String.format("%d sessions displayed \n", lFilteredTSList.size()));
    ...
    for (TraceSession lTS : lFilteredTSList) {
      try {
        ...
        diagramMessages.add(lSipTextFormatter.format(lTS));
  ...
  public static void main(String[] args) throws Exception {
    ...
    JCommander lJCommander = new JCommander(lTF, "/Users/gogasca/Downloads/sample.txt","-hsl","-v");
    if (lTF.isShowHelp()) {
      // Displays help
      lJCommander.usage();
    } else {
